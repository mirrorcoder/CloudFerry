...
from cloudferrylib.vmware.actions import transfer_disks_volume
...
class Vmware2OSFerry(cloud_ferry.CloudFerry):
    ...
    def process_migrate(self):
        ...
        transfer_disks_volume_task = transfer_disks_volume.TransferDisksVolume(self.init, 'src_cloud')
        ...
        return (get_filter_task >> get_info_instances_task >> stop_vms_task >>
                ...
                transfer_disks_volume_task >> act_attaching)
